...
import com.example.appmucsic.MyExoplayer
import com.example.appmucsic.PlayerActivity
import com.example.appmucsic.databinding.SectionSongListRecyclerRowBinding
...
class SectionSongListAdapter(private  val songIdList : List<String>) :
    ...
    class MyViewHolder(private val binding: SectionSongListRecyclerRowBinding) : RecyclerView.ViewHolder(binding.root){
        //Liên kết dữ liệu để hiện danh sách
